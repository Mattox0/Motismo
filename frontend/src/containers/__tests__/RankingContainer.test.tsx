...
describe('RankingContainer', () => {
  const mockStatistics: IRankingStatistics = {
    ...
    totalPlayers: 3,
    ranking: [
      { id: '1', name: 'User 1', points: 100, rank: 1, avatar: 'avatar1', isAuthor: false, isFastest: false },
      { id: '2', name: 'User 2', points: 80, rank: 2, avatar: 'avatar2', isAuthor: false, isFastest: false },
      { id: '3', name: 'User 3', points: 60, rank: 3, avatar: 'avatar3', isAuthor: false, isFastest: false },
    ],
  };

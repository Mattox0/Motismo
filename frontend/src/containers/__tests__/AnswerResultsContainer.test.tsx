...
describe('AnswerResultsContainer', () => {
    ...
    choices: [
      {
        ...
        isCorrect: true,
        users: [
          { id: 'user1', name: 'User 1', avatar: 'avatar1' },
          { id: 'user2', name: 'User 2', avatar: 'avatar2' },
        ],
        count: 2,
        percentage: 50,
      },
      {
        ...
        choiceText: 'Choice 2',
        isCorrect: false,
        users: [{ id: 'user3', name: 'User 3', avatar: 'avatar3' }],
        count: 1,
        percentage: 25,
      },
      {
  ...
  const renderComponent = () => {
    return render(
      <AnswerResultsContainer statistics={mockStatistics} handleClick={mockHandleClick} />
    );
  };
